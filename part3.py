# worked with Jason Jiang(Section D) and Shangmin Chen (Section B)
# Email of both:
# Jason: Jx3onj@bu.edu
# Shangmin: Shangmin@bu.edu
...
#self created parameter
def punctuations(s): 
    '''accepts a string as a parameter. The function should then return the punctation of s''' 
...
class TextModel():
    ...
    def add_string(self, s):
        ...
        # if len(y) not in self.sentence_lengths:
        #     self.sentence_lengths[len(y)] = 1
        # elif len(y) in self.sentence_lengths:
        #     self.sentence_lengths[len(y)] += 1
        # initalize variable
        ##########################
        ...
        ##########################
        if punctuations(s) not in self.punctuations:
            self.punctuations[punctuations(s)] = 1
        elif punctuations(s) in self.punctuations:
            self.punctuations[punctuations(s)] += 1 
